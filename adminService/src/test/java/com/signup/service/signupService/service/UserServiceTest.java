...
public class UserServiceTest {
    ...
    public void loginTest(){
        ...
        User user = new User(new ObjectId("636f53a49d049c667ed459e2"),"mohit", "asdfgh", "asdfgh", "first@gmail.com");

        List<User> userList = new ArrayList<>();
        userList.add(user);

        when(repository.loginUser("mohit")).thenReturn(userList);

        String res = service.loginService("mohit", "asdfgh");
    ...
    public void loginFailedTest(){
        ...
        String res = service.loginService("mohit", "random_password");
